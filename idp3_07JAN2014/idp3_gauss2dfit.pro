; $Id: gauss2dfit.pro,v 1.5 1998/01/15 18:42:15 scottm Exp $
;
...
Function idp3_Gauss2dfit, z, a, x, y, NEGATIVE = neg, TILT=tilt, sigma=sigma, $
	      chisq=chisq
;+
; NAME:
;	GAUSS2DFIT
...
result = curvefit([nx, ny, x, y], reform(z, n, /OVERWRITE), $
		replicate(1.,n), a, sigma, itmax=50, chisq=chisq, $
